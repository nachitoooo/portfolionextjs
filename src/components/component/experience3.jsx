...
import { FaPython, FaPaypal } from "react-icons/fa";
import { FaSass, FaBootstrap} from "react-icons/fa";
import { FaCcPaypal } from "react-icons/fa";

const WorkExperienceItem3 = () => {
    return (
      <div className="relative mx-4 md:mx-12 pb-8 md:pb-12 grid before:absolute before:left-[-25px] before:block before:h-full before:border-l-2 before:border-gray-200 dark:before:border-gray-800 before:content-[''] md:grid-cols-5 md:gap-10 md:space-x-4 md:before:left-[-37px]">
        <div className="relative pb-8 md:pb-12 md:col-span-2">
          <div className="sticky top-4 md:top-28">
            <h3 className="text-lg md:text-xl font-bold text-gray-700 dark:text-gray-200">Online Coaching </h3>
            <time className="text-xs md:text-sm text-gray-700 dark:text-gray-300">9/23 - 3/24</time>
            <p className="text-sm text-gray-600 mt-2 dark:text-gray-100">I developed a page for a personal trainer focused on calisthenics offering different products.
Among them are training books and recipe books, as well as payment processing for personalized attention whether it is increasing body mass or losing fat.</p>
            <div className="flex gap-2 mt-2">
              ...
              <FaSass className="text-pink-700" size={50}/>
              <FaCcPaypal className="text-blue-600" size={55} />
...
export default WorkExperienceItem3;